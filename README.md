...
- **搜索深度**: 由极速、标准、困难、大师四档难度控制
- **移动排序**: 优先搜索吃子和强子移动，提高剪枝效率
- **走法变化**: 从评分接近最优的前五个候选中随机选择，避免固定套路和明显坏棋
...
### 调整AI难度
在页面的“难度”选项中选择极速、标准、困难或大师。标准为默认档位；更高档位会显著增加检索时间。
...
检索耗时取决于当前局面的可选走法数量及设备性能。通常“极速”和“标准”适合手机端快速对局；“困难”和“大师”会检索更多局面，等待时间也会明显增加。
